...
hi MatchParen	guifg=fg	guibg=#99ccff	gui=NONE	ctermfg=fg	ctermbg=cyan	cterm=NONE
...
" windows, statusline
hi StatusLine	guifg=bg	guibg=#000000	gui=NONE	ctermfg=bg	ctermbg=black	cterm=NONE
hi StatusLineNC	guifg=fg	guibg=#bbbbbb	gui=NONE	ctermfg=fg	ctermbg=gray	cterm=NONE
hi VertSplit	guifg=fg	guibg=#eeeeee	gui=NONE	ctermfg=fg	ctermbg=255	cterm=NONE
...
" vim >= 7.0 only
if version >= 700
  hi CursorLine		guibg=#ffffaf	gui=NONE		ctermbg=229	cterm=NONE
  hi CursorColumn		guibg=#ffffaf	gui=NONE		ctermbg=229	cterm=NONE
...
hi MoreMsg	guifg=#c96f00	guibg=bg	gui=NONE	ctermfg=brown	ctermbg=bg	cterm=NONE
hi ModeMsg	guifg=#c96f00	guibg=#ebf6bc	gui=NONE	ctermfg=brown	ctermbg=bg	cterm=NONE
hi SpecialKey	guifg=#309090	guibg=bg	gui=NONE	ctermfg=darkcyan	ctermbg=bg	cterm=NONE


" Default Syntax Highlight {{{1
"~~~~~~~~~~~~~~~~~~~~~~~~~~
hi Comment	guifg=#008700	guibg=bg	gui=NONE	ctermfg=28	ctermbg=bg	cterm=NONE
hi SpecialComment	guifg=#707090	guibg=bg	gui=NONE	ctermfg=darkgray	ctermbg=bg	cterm=NONE

hi Constant	guifg=#4600db	guibg=bg	gui=NONE	ctermfg=darkblue	ctermbg=bg	cterm=NONE
hi Character	guifg=#005f00	guibg=bg	gui=NONE	ctermfg=darkgreen	ctermbg=bg	cterm=NONE
hi String	guifg=#e50000	guibg=bg	gui=NONE	ctermfg=darkred	ctermbg=bg	cterm=NONE
hi link Number	Constant
hi link Boolean	Constant
hi link Float	Constant

hi Identifier	guifg=#c96f00	guibg=bg	gui=NONE	ctermfg=brown	ctermbg=bg	cterm=NONE
hi Function	guifg=#c96f00	guibg=bg	gui=NONE	ctermfg=brown	ctermbg=bg	cterm=NONE

hi Statement	guifg=#ce00a0	guibg=bg	gui=NONE	ctermfg=darkmagenta	ctermbg=bg	cterm=NONE
...
hi PreProc	guifg=#c96f00	guibg=bg	gui=NONE	ctermfg=brown	ctermbg=bg	cterm=NONE
hi link Include	PreProc
hi link Define	PreProc
hi link Macro	PreProc
hi link PreCondit	PreProc

hi Type	guifg=#ce00a0	guibg=bg	gui=NONE	ctermfg=darkmagenta	ctermbg=bg	cterm=NONE
