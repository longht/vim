...
hi DiffAdd        cterm=NONE        ctermfg=fg    ctermbg=17
hi DiffChange     cterm=NONE        ctermfg=fg    ctermbg=237
hi DiffDelete     cterm=NONE        ctermfg=234   ctermbg=60
hi DiffText       cterm=NONE        ctermfg=fg    ctermbg=53
hi Directory      cterm=NONE        ctermfg=179   ctermbg=bg
hi ErrorMsg       cterm=NONE        ctermfg=196   ctermbg=236
hi Folded         cterm=NONE        ctermfg=103   ctermbg=237
...
hi Title          cterm=bold        ctermfg=230   ctermbg=bg
